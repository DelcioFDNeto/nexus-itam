  ...
  return (
    <div className="max-w-[1920px] mx-auto pb-24 animate-fade-in relative min-h-screen">
        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-700 flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="hidden md:flex gap-2 items-center">
            ...
            <button
              ...
              className="p-3 bg-gray-50 dark:bg-slate-900 hover:bg-gray-100 rounded-2xl border border-gray-100 dark:border-slate-700 text-gray-600 transition-colors"
            >
              {sortOrder === "asc" ? (
                <ArrowDownAZ size={20} />
              ) : (
            ...
            <div className="hidden md:block bg-white dark:bg-slate-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
              <div className="overflow-x-auto custom-scrollbar">
                <table className="w-full text-left border-collapse">
                  <thead className="bg-[#FAFAFA] border-b border-gray-100 dark:border-slate-700 sticky top-0 z-10 backdrop-blur-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {processedAssets.map((asset) => {
                      ...
                      return (
                        <tr
                          key={asset.id}
                          className={`hover:bg-gray-50/80 transition-all group cursor-pointer ${selectedIds.includes(asset.id) ? "bg-gray-50 dark:bg-slate-900" : ""}`}
                          onClick={() => navigate(`/assets/${asset.id}`)}
                        >
                          <td
      ...
      {selectedIds.length > 0 && (
        ...
        >
          <div className="flex items-center gap-3">
            <div className="bg-white dark:bg-slate-800 text-black w-6 h-6 rounded-full flex items-center justify-center font-black text-xs">
              {selectedIds.length}
            </div>
